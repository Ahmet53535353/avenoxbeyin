...
INSTALL_JS_GLOBAL="/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
