...
- **Global scope**: `/home/hayalet/Projects/avenoxbeyin/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/hayalet/Projects/avenoxbeyin/.claude/notes/`)
...
2. Glob `/home/hayalet/Projects/avenoxbeyin/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/hayalet/Projects/avenoxbeyin/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/hayalet/Projects/avenoxbeyin/.claude/notes/` — works in any directory
