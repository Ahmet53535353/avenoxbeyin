...
```bash
INIT=$(node "/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/templates/spec.md.
