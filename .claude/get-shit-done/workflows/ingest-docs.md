...
```bash
INIT=$(node "/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
