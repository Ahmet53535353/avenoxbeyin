...
```
Agent(
  prompt="Read /home/hayalet/Projects/avenoxbeyin/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/templates/VALIDATION.md`
