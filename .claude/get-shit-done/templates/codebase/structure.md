...
- Usage: Reference from command with `@/home/hayalet/Projects/avenoxbeyin/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/hayalet/Projects/avenoxbeyin/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/hayalet/Projects/avenoxbeyin/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
