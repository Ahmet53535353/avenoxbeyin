...
BEYIN_DIR = Path(os.environ.get("BRAIN_VAULT", "~/Brain")).expanduser() / ".beyin"
...
def _launch_flush(
    ...
    *,
    ...
    script = vault_root / ".beyin" / "flush.py"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--vault-root", type=Path, default=Path(os.environ.get("BRAIN_VAULT", "~/Brain")).expanduser())
