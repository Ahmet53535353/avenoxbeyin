...
| Aday var, sürüm `2.1.0` | v2.2 yükseltmesini çalıştır (OpenCode eklentisi + güvenlik sertleştirmesi) |
| Aday var, sürüm `2.2.0` | Güncel. OpenCode ise `python scripts/install_opencode.py --vault-path <vault>` çalıştır |
